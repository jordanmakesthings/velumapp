      ...
      <div className="w-full max-w-[400px] flex flex-col items-center pt-16">
        ...
        {!device && (
          <div className="w-full flex flex-col items-center">
            <p className="text-accent text-[10px] font-sans font-medium tracking-[2.5px] uppercase text-center mb-4">
              What device are you using?
            </p>
            <div className="w-full flex flex-col gap-3 mb-8">
              <button onClick={() => setDevice("ios")}
                className="w-full velum-card p-5 flex items-center justify-between text-left">
                <div>
