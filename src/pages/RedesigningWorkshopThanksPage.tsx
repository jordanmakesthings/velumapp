// Post-checkout thank-you page for The Redesigning Reality Workshop.
// Lives at /redesigning-workshop/thanks — set as success URL on the Stripe Payment Link.
// Pure black-on-white brand. Zoom link emailed 72 hours before the workshop.

const WORKSHOP_DATETIME_ISO = "20260613T100000/20260613T120000"; // for calendar add links
const WORKSHOP_TITLE = "The Redesigning Reality Workshop with Jordan";
  ...
  return (
    <div className="min-h-screen w-full bg-white text-black">
      <article className="mx-auto w-full max-w-[660px] px-6 py-16 lg:py-24 text-[17px] leading-[1.7]">
        ...
        {/* The details card */}
        <div className="border border-black/15 bg-neutral-50 rounded-lg p-6 mb-10">
        ...
        <div className="flex flex-wrap gap-3 mb-12">
          <a href={cal.google} target="_blank" rel="noopener" className="rounded-full border border-black/30 px-5 py-2.5 text-[13px] font-medium hover:border-black hover:bg-black hover:text-white transition-colors">Google Calendar</a>
          <a href={cal.apple} download="redesigning-workshop.ics" className="rounded-full border border-black/30 px-5 py-2.5 text-[13px] font-medium hover:border-black hover:bg-black hover:text-white transition-colors">Apple Calendar</a>
          <a href={cal.outlook} target="_blank" rel="noopener" className="rounded-full border border-black/30 px-5 py-2.5 text-[13px] font-medium hover:border-black hover:bg-black hover:text-white transition-colors">Outlook</a>
        </div>
        ...
        <div className="border-t border-neutral-200 pt-8">
          <p className="italic text-neutral-600 mb-3">If anything comes up between now and Saturday — questions, life happening, you can't make it — just email me.</p>
          <p className="mb-1"><a href="mailto:hello@govelum.com" className="text-black underline underline-offset-2">hello@govelum.com</a></p>
